        ...
        <main class="py-4">
          <div class="container">
              <div class="row justify-content-center">
                  <div class="col-md-8">
                      <div class="card">
                          <div class="card-header"><h2>Edit {{$product->title}}</h2></div>
                          <div class="col-sm-6 cent-box">
                              <form action="{{ route('products.update', ['product' => $product->id]) }}" method="POST">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-12">
                                    <input class="form-control" type="text" value="{{$product->title}}" name="name">
                                  </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-12">
                                    <input class="form-control" type="url" value="{{$product->image}}" name="image">
                                  </div>
                                </div>
                                <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                @endforeach
                                  <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="exampleTextarea" rows="3" name="description">{{$product->description}}</textarea>
                                  </div>
                                </div>
                                <div class="form-group">
